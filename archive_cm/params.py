...
# NOTE: Units are converted from mm/us to cm/us in wreos.py
B = 2.50  # -
C = 0.70  # -
Z = -0.8066  # -
gamma_0_r = 1.22  # -
...
#TMD = 1.76  # g/cm^3
#p_0 = 1.0e-9  # GPa (equivalent to 1 atmosphere)
p_0_wr = 1.01325e-09  # GPa (equivalent to 1 atmosphere)
rho_0_wr = 1.32  # g/cm3 # rho_0 = TMD * Phi_0 = 0
v_0_wr = (rho_0_wr)**(-1)  # cm3/g
#C_v = 992.0  # J / kg K
...
p_c = 1.5899  # Gpa
p_c = 1.5899*1e-2  # Gpa  -->  g cm-1 us-2
...
e_0_guess = 3.3010903245948296e-05  # cm2 us-2
e_0_guess = 3.293552507180741e-05
e_0_guess = 0.03301082786777416
#e_0_guess = 3.301090249216656
