...
tf = 0.003  # us (microseconds) # Simulation finish time
...
N = 90 # Number of discrete spatial elements
...
p_cj = np.interp(rho_0, np.array(RHO_0), P_CJ_L) * 1e-3   # g mm-1 us-2
...
e_0_guess = 0.2957648  # 2021.10.16
e_0_guess = 0.890969556421919  # 2021.10.16
